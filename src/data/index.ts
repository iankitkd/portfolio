...
export const heroData = {
  ...
  title: "builds scalable web apps.",
  description:
    "Full-stack web developer focused on clean interfaces, reliable APIs and practical product experiences.",
  ...
  highlights: ["Full-stack Developer", "Open to Opportunities"],
...
export const resumeUrl =
  "https://drive.google.com/file/d/1TdymfAvzVaAPo9Aix01NOprshTqTW0gl/view?usp=sharing";
...
export const contactLinks = [
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/in/iankitkd",
    Icon: FaLinkedin,
  },
...
export const projects = [
  ...
  },
  {
    title: "Feed Social",
    description:
      "A social media platform with secure authentication, post creation, likes, replies, and real-time messaging.",
    technologies: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
  ...
  },
  {
    title: "CoderPort",
    description:
      "A unified dashboard that brings all coding profiles together to track programming progress and growth in one place.",
    technologies: [
      "Next.js",
      "TypeScript",
      "Tailwind CSS",
  ...
  },
  {
    title: "RF Check",
    description:
      "A fact-checking web app that verifies text authenticity (real or fake) using AI models and OCR and give result with detail explanation.",
  ...
  },
  {
    title: "CinePick",
    description:
      "A movie and TV show discovery app with category-based browsing, detailed pages with trailers and cast info, and a persistent watchlist.",
    technologies: [
      "React",
      "Tailwind CSS",
      "TMDB API",
